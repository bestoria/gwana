...
import TwoPanelLayout from '@/src/shared/components/layouts/TwoPanelLayout';
import NewsFeedView from '@/src/shared/components/news/NewsFeedView';
import NewsControlPanel from '@/src/shared/components/news/NewsControlPanel';
